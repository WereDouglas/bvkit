        ...
        <div class="wrapper">
            <div class="login_page">
                <div class="registration">
                    ...
                    <div class="panel-heading border login_heading">Physician registration</div>	
                    <?php echo $this->session->flashdata('msg'); ?>
                    <form id="station-form" parsley-validate novalidate role="form" class="form-horizontal" name="login-form" enctype="multipart/form-data"  action='<?= base_url(); ?>index.php/physician/create'  method="post">
                        ...
                        <div class="form-group">
                           ...
                           <div class="form-group">
                            <div class="col-sm-10">
                                ...
                                <select class="form-control" id="gender" name="designation"> 
