        ...
        <div class="col-md-12">
            <div class="block-web">
                <div class="header">
                    ...
                    <h3 class="content-header">FAMILY</h3>
                                ...
                                if (is_array($patients) && count($patients)) {
                                    foreach ($patients as $loop) {
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td id="name:<?php echo $loop->patientID; ?>" contenteditable="true">
                                                <?php echo $loop->name; ?>
                                            </td>

                                            <td id="email:<?php echo $loop->patientID; ?>" contenteditable="true"><?php echo $loop->email; ?></td>
                                            <td id="dob:<?php echo $loop->patientID; ?>" contenteditable="true">
                                                <?php echo $loop->dob; ?>
                                            </td>
                                            <td id="contact:<?php echo $loop->patientID; ?>" contenteditable="true"><?php echo $loop->contact; ?></td>
                                            <td id="gender:<?php echo $loop->patientID; ?>" contenteditable="true"><?php echo $loop->gender; ?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                ...
                <form id="station-form" parsley-validate novalidate role="form" class="form-horizontal" name="login-form" enctype="multipart/form-data"  action='<?= base_url(); ?>index.php/family/create'  method="post">
